// document.addEventListener("DOMContentLoaded", function() {
    ...
    const nombre_comparaison = document.getElementById('nombre-comparaison');
    const nombre_quiz = document.getElementById('nombre-quiz');
    var itemsPerPage;
    
    if (nombre_comparaison !== null){
        itemsPerPage = 9;
    }
    else if (nombre_quiz !== null){
        itemsPerPage = 8;
    }
    else{
        itemsPerPage = 15   ;
    ...
    console.log(nombre_comparaison)
    console.log(nombre_quiz)
