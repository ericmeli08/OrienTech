...
<head>
    <meta charset="UTF-8">
    <link rel="icon" sizes="500x500" type="image/x-icon" href="<?=URL_IMG ?>logo_fs.jpeg">
...
<body>
    <div class="container">
        <nav>
			...
			<ul>
				<li class="nav-item"><a href="<?= URL_CONTROLLER2 ?>acceuilController.php" class="nav-link">Acceuil</a></li>
